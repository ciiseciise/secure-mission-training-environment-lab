...
![DC01 Successful Logon Event 4624](dc01-security-event-4624.png)

## Failed Logon Event

Event ID `4625` shows a failed logon attempt caused by an incorrect username or password.

![DC01 Failed Logon Event 4625](dc01-security-event-4625.png)
...
![DC01 Group Change Event 4728](dc01-security-event-4728-group-change.png)
